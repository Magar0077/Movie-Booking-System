...
const MOVIES = [
    { id: "movie_1", title: "Inception", genre: ["Sci-Fi", "Thriller"], rating: 8.8, synopsis: "A thief who enters dream worlds...", duration: 148, status: "now_showing" },
    ...
    { id: "movie_4", title: "Avengers: Endgame", genre: ["Action", "Sci-Fi"], rating: 8.4, synopsis: "The Avengers assemble one last time...", duration: 181, status: "now_showing" },
    { id: "movie_5", title: "Parasite", genre: ["Thriller", "Drama"], rating: 8.5, synopsis: "A dark tale of class divide...", duration: 132, status: "now_showing" },
    { id: "movie_6", title: "Joker", genre: ["Crime", "Drama"], rating: 8.4, synopsis: "A troubled man descends into madness...", duration: 122, status: "now_showing" },
    { id: "movie_7", title: "Dune", genre: ["Sci-Fi", "Adventure"], rating: 8.1, synopsis: "A noble family becomes embroiled in war...", duration: 155, status: "coming_soon" },
    { id: "movie_8", title: "The Matrix", genre: ["Sci-Fi", "Action"], rating: 8.7, synopsis: "A hacker discovers the truth about reality...", duration: 136, status: "now_showing" },
    { id: "movie_9", title: "Titanic", genre: ["Romance", "Drama"], rating: 7.9, synopsis: "A love story aboard a doomed ship...", duration: 195, status: "now_showing" },
    { id: "movie_10", title: "Oppenheimer", genre: ["Drama", "History"], rating: 8.9, synopsis: "The story of the father of the atomic bomb...", duration: 180, status: "coming_soon" }
];
...
export async function seedFirestore() {
    const movieRef = collection(db, "movies"); // Fixed collection reference
    ...
    for (const theatre of THEATRES) {
        await setDoc(doc(db, "theatres", theatre.id), theatre); // Fixed spelling to 'theatres'
    }
    ...
    for (const show of SHOWTIMES) {
        ...
        // Generate and seed seats for this specific showtime
        const showSeats = generateSeats(show.id);
